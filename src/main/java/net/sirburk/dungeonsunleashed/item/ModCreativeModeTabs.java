    ...
    public static final RegistryObject<CreativeModeTab> DUNGEONSUNLEASHED_TAB = CREATIVE_MODE_TABS.register("dungeonsunleashed_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModBlocks.CUT_POLISHED_GRANITE.get()))
                    ...
                    .displayItems((displayParameters, output) -> {
                        ...
                        output.accept(ModBlocks.SEAWEED_ENCRUSTED_CUT_POLISHED_GRANITE_STAIRS.get());
                        output.accept(ModBlocks.SEAWEED_ENCRUSTED_CUT_POLISHED_GRANITE_SLAB.get());
                        output.accept(ModBlocks.SEAWEED_ENCRUSTED_CUT_POLISHED_GRANITE_WALL.get());
